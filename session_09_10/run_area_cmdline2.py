...
import numpy as np  # could use "from numpy import *" to avoid typing numpy

# Define the inputs at the top, so they are easy to find and change
value_list1 = np.linspace(1,2,num=11)   # num chosen so nicely spaced
value_list2 = np.arange(1.,0.,-0.25)
...
for radius in value_list1:    # don't forget the colon!
    my_command = "./area_cmdline.x " + str(radius) + " 1"  # convert radius to a string
