...
double f_msu_parameters (double x, void *params_ptr);
...
msu_parameters;			// now we can define a structure of this type
				//   using the keyword "msu_parameters" 
...
main (void)
{
  ...
  msu_parameters my_coefficients;
  ...
  params_ptr = &my_coefficients;	// now point to an osu_parameter structure 
  cout << "Expected: a = " << my_coefficients.a
    << ", b = " << my_coefficients.b
    << ", c = " << my_coefficients.c
    << ", num = " << my_coefficients.num << endl;
  returned_result = f_msu_parameters (x, params_ptr);
  cout << "The returned result is " << returned_result 
       << ". Is it correct?" << endl << endl;
...
//******************** f_osu_parameters ***********************
double
f_msu_parameters (double x, void *params_ptr)
{
  msu_parameters *passed_ptr;
  passed_ptr = (msu_parameters *) params_ptr;

  double passed_double_1 = ((msu_parameters *) params_ptr)->a;
  double passed_double_2 = passed_ptr->b;
  double passed_double_3 = ((msu_parameters *) params_ptr)->c;
  int passed_int = ((msu_parameters *) params_ptr)->num;
